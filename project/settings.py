...
SECRET_KEY = 'django-insecure-y2l1*z0*cc-5a2fg+7@o56isdxpq77b9axww5ib4)_m^rgzt%0'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# ALLOWED_HOSTS = []
ALLOWED_HOSTS = ['specialist-test.onrender.com']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'base.context_processors.photo_gallery_view_context',  
                'base.context_processors.payment_methods_view',  
                'base.context_processors.contactus',  
            ],
        },
    },
]
...
EMAIL_HOST_PASSWORD = 'qbzo aloh ugzb osfr'
DEFAULT_FROM_EMAIL = 'hossamheiba7@gmail.com'
ADMIN_EMAIL = ['hossamheiba6@gmail.com', 'hossamheiba7@gmail.com']



JAZZMIN_SETTINGS = {
    "welcome_sign": "Welcome to the Specialist",

    "site_title": "DashBoard Specialist",

    "site_header": "DashBoard Specialist",

    "site_brand": "Specialist",
